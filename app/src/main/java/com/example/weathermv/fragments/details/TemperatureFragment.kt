...
class TemperatureFragment : Fragment() {
    ...
    private var _binding: FragmentTemperatureDayBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTemperatureDayBinding.inflate(inflater, container, false)
...
//                legend.isEnabled = false
        ...
        Log.d("enter","onCreateView - $entries")
        return binding.root
    }
